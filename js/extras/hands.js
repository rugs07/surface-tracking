...
*/
  ...
  function Sa(a) {
    ...
    b &&
      ((c = A(Ta(c, a))), (b = c.next().value), (a = c.next().value), (c = b));
    G = c >>> 0;
    H = a >>> 0;
  }
    ...
    if (16 > a.length) Sa(Number(a));
      ...
      for (
        ...
        (d = Number(a.slice(d, e))),
          (H *= 1e6),
          (G = 1e6 * G + d),
          4294967296 <= G && ((H += (G / 4294967296) | 0), (G %= 4294967296));
      b &&
        ((b = A(Ta(G, H))),
        (a = b.next().value),
        (b = b.next().value),
  ...
  function kb(a) {
    ...
    var b = a.V;
    b =
      null == b || (Ia && null != b && b instanceof Uint8Array)
        ? b
        : "string" === typeof b
        ? Na(b)
        : null;
  ...
  function lb(a) {
    if ("string" === typeof a) return { buffer: Na(a), C: !1 };
    ...
    if (a.constructor === ib) return { buffer: kb(a) || Pa(), C: !0 };
  ...
  function Lb(a, b, c, d) {
    ...
    if (d) g & 2 || P(e, 2), c & 1 || Object.freeze(e);
      ...
      c & 1 || !f
        ? d && g & 16 && !f && zb(e, 16)
        : ((e = Ab(Array.prototype.slice.call(e))), Kb(a, b, e));
    }
    return e;
  }
  function Mb(a, b) {
  ...
  function X(a, b, c) {
    ...
    if (c) {
      ...
      for (k = 0; k < c.length; k++)
        (f = c[k]),
          f < e
            ? ((f += this.G), (d = a[f]) ? ac(d, b) : (a[f] = Fb))
            : (n || (n = Jb(this)), (d = n[f]) ? ac(d, b) : (n[f] = Fb));
    }
  }
  ...
  function lc(a, b) {
    ...
    return Array.isArray(c) &&
      (mc in c || nc in c || (0 < c.length && "function" == typeof c[0]))
      ? c
      : void 0;
  }
  ...
  var Y = Ac(
    ...
    Bc = Ac(
      ...
      function (a, b, c) {
        b = S(b, c);
        null != b &&
          ("string" === typeof b && Wa(b),
          null != b &&
            (M(a.h, 8 * c),
            "number" === typeof b
              ? ((a = a.h), Sa(b), sb(a, G, H))
              : ((c = Wa(b)), sb(a.h, c.i, c.h))));
      }
    ),
    Cc = Ac(
      function (a, b, c) {
      ...
      function (a, b, c) {
        b = S(b, c);
        if (null != b && null != b)
          if ((M(a.h, 8 * c), (a = a.h), (c = b), 0 <= c)) M(a, c);
          else {
    ...
    Dc = Ac(
      function (a, b, c) {
        ...
        if (db) {
          var g = a,
            f;
          (f = cb) || (f = cb = new TextDecoder("utf-8", { fatal: !0 }));
          a = e + d;
          ...
          for (var k = null, l, m; h < d; )
            (l = a[h++]),
              128 > l
                ...
                : K(),
              8192 <= e.length && ((k = ab(k, e)), (e.length = 0));
          h = ab(k, e);
        }
        U(b, c, h);
        return !0;
                      ...
                      if (t.ba)
                        for (v = 0; v < t.ba.length; ++v)
                          (B = q.data),
                            ...
                            (C = new Z()),
                            V(C, 2, u.score),
                            u.index && U(C, 1, u.index),
                            u.label && U(C, 3, u.label),
                            u.displayName && U(C, 4, u.displayName),
                            (u = C.l()),
                            J.call(B, I, u);
                    }
                    q = q.data;
